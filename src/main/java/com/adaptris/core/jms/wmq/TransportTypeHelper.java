...
public class TransportTypeHelper {
  ...
  public enum Transport {
    MQJMS_TP_BINDINGS_MQ(WMQConstants.WMQ_CM_BINDINGS), MQJMS_TP_CLIENT_MQ_TCPIP(WMQConstants.WMQ_CM_CLIENT), MQJMS_TP_DIRECT_TCPIP(
        WMQConstants.WMQ_CM_DIRECT_TCPIP), MQJMS_TP_DIRECT_HTTP(WMQConstants.WMQ_CM_DIRECT_HTTP);
   ...
   *
   * @param s
   *          the configured string, if unknown, then assumes that {@link Integer#parseInt(String)} will work.
