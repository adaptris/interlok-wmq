 ...
 * <p>
 * This implementation is one that creates a new MQQueueManager for each invocation of connect(). This type of connection means that
 * all MQQueueManager instances will only be connected for the duration of a single message flow through the adapter.
 * </p>
 * <p>
 * This is the preferred connection for connecting to WebsphereMQ. An <code>AttachedConnection</code> may stop WebsphereMQ from
